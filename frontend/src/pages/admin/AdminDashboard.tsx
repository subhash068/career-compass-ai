...
export default function AdminDashboard() {
  ...
  const handleUserFormSuccess = () => {
    // Refresh user list after create/edit/delete
...
const navItems = [
    ...
    { id: 'chatbot', label: 'Admin AI Assistant', icon: Bot },
        ...
        <div className="p-6 my-7">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center overflow-hidden">
              <img src="/career-logo.png" alt="Career Compass Logo" className="w-8 h-8 object-contain" />
            </div>
            <div>
