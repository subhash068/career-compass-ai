...
class AISettings:
    ...
    # LLM Settings - Disabled by default for performance
    ...
    # RAG Settings - Disabled by default for performance
    ...
    EMBEDDING_RETRY_COUNT: int = int(os.getenv("EMBEDDING_RETRY_COUNT", "3"))
    EMBEDDING_TIMEOUT: int = int(os.getenv("EMBEDDING_TIMEOUT", "30"))
    EMBEDDING_USE_FALLBACK: bool = os.getenv("EMBEDDING_USE_FALLBACK", "true").lower() == "true"
    HF_HUB_OFFLINE: bool = os.getenv("HF_HUB_OFFLINE", "false").lower() == "true"

    # Evaluation Settings - Disabled by default for performance
    ENABLE_EVALUATION: bool = os.getenv("ENABLE_EVALUATION", "false").lower() == "true"
    EVALUATION_METRICS: list = ["relevance", "grounding", "hallucination", "user_feedback"]

    # Memory Settings - Disabled by default for performance
