...
class AdminService:
            ...
            "users": [
                {
                    ...
                    "name": user.name,
                    "role": user.role,
                    "currentRole": getattr(user, 'current_role', None),
    ...
    def get_user_details(
        ...
        return {
            ...
            "skills": [
                {
                    "name": skill.skill.name if hasattr(skill, 'skill') and getattr(skill.skill, 'name', None) else f"Skill {skill.skill_id}",
                    "level": getattr(skill, 'inferred_level', skill.level),
            ...
            "assessments": [
                {
                    ...
                    "user_name": assessment.user.name if hasattr(assessment, 'user') and assessment.user and assessment.user.name else "Unknown",
                    "user_email": assessment.user.email if hasattr(assessment, 'user') and assessment.user and assessment.user.email else "Unknown",
